...
const ReviewCard = ({itemId, item,className = "" }: props) => {

    return (
        <>
            <div id={itemId} className={`flex flex-col xl:w-[32.2%] xl:h-[263px] md:w-[48.5%] md:h-[212px] sm:w-[99%] sm:h-[221px] w-[99%] h-[221px] xl- border border-[#F59E0B] rounded-xl ${className}`}>
